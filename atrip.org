...
through the =blockSize= variable.
...
// instantiate
  template void singlesContribution( size_t No
                                   , size_t Nv
                                   , const ABCTuple &abc
                                   , double* const Tph
                                   , double* const VABij
  ...
  for ( size_t
    ...
    if (!isFakeTuple(i)) {
      ...
      singlesContribution<F>( No, Nv, abc
                            ...
                            , Tai.data()
#endif
                            , (F*)abhh.unwrapSlice(Slice<F>::AB, abc)
                            , (F*)abhh.unwrapSlice(Slice<F>::AC, abc)
                            , (F*)abhh.unwrapSlice(Slice<F>::BC, abc)
#if defined(HAVE_CUDA)
                            , (F*)Zijk);
#else
                            , Zijk.data());
